...
field.generate_random(1000, mass=[100, 900], r_x=[0, 2000], r_y=[
                      0, 6000], r_0=-1000, alpha=[0, 360], velocity=[0, 500])
field.add_body(Body(x0=0, y0=0, v_x=100, v_y=100, mass=9999))


field.generate_random(1000, mass=[100, 900], r_x=[0, 1000], r_y=[0, 6000], alpha=[0, 360],r_0=19000,velocity=[0,500])
...
field.save_animation(frames=150, size_body=5)  # size_body=100
